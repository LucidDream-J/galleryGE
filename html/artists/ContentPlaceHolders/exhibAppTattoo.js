...
function getData() {
  header.innerHTML = `<img id="exhibition-image" class="card-img-top" src="../../images/artistsImages/japanesePrints/tattoo/Kunichikatrip.jpg" alt="Art image">`;
  title.innerText = `Tattoo prints`;

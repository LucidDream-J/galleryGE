...
function getData() {
  header.innerHTML = `<img id="exhibition-image" class="card-img-top" src="../images/artistsImages/nextExhib/Atake.jpg" alt="Art image" title="Nathan Beard">`;
...
<br> <img id="exhibition-image" class="card-img-top" src="../images/artistsImages/nextExhib/i0TA21.png" alt="sponsors">`;

...
function getData() {
  header.innerHTML = `<img id="exhibition-image" class="card-img-top" src="../../images/artistsImages/langdon/Digest1.jpg" alt="Art image">`;
  title.innerText = `Pam Langdon`;
  excerpt.innerHTML = `<p>Pam Langdon transforms discarded, unloved books by intricately folding and rolling the pages to form spirals reflecting growth papperns in nature.</p>
<p></p>
`;

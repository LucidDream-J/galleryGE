...
function getData() {
  header.innerHTML = `<img id="exhibition-image" class="card-img-top" src="../../images/artistsImages/japanesePrints/250PrintsBooks/MEL10.jpg" alt="Art image">`;
  title.innerText = `250 Years of Japanese Prints II`;

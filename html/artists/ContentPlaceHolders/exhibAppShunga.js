...
function getData() {
  header.innerHTML = `<img id="exhibition-image" class="card-img-top" src="../../images/artistsImages/japanesePrints/shunga/NM2.jpg" alt="Art image">`;
  title.innerText = `Shunga`;

...
function getData() {
  header.innerHTML = `<img id="exhibition-image" class="card-img-top" src="../../images/artistsImages/japanesePrints/floraFauna/PER65.jpg" alt="Art image">`;
  title.innerText = `250 Years of Japanese Prints III`;
